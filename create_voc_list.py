...
devkit_dir = './data/MOT20Det/VOCdevkit'
years = ['2007', '2012']
...
def prepare_filelist(devkit_dir, output_dir):
    ...
    with open(osp.join(output_dir, 'data/train.txt'), 'w') as ftrainval:
        for item in trainval_list:
            ftrainval.write(item[0] + ' ' + item[1] + '\n')

    with open(osp.join(output_dir, 'data/valid.txt'), 'w') as ftest:
